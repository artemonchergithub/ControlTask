sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/ControlTaskVylegzhanin/app", ".html");
		...
		return Opa5.extend("zjblessons.ControlTaskVylegzhanin.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/ControlTaskVylegzhanin/localService/mockserver"], function (mockserver) {
